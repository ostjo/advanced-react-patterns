...
**_Continuation of previous exercise!_**

When we implicitly share props with children by simply cloning them, the
**props** will only be **available to immediate children**. Therefore, a nested
component won't have our compound component's props.

> **Solution:** To fix this, we can provide the props to all of the children via
> **React Context** instead, like so:
